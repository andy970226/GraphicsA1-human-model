...
public class A1App implements GLEventListener {
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        //this cube just for the convenience to indicate the positive direction.
        gl.glTranslatef(8f,8f,8f);  
...
gl.glColor3f(1.0f,0.5f,0.0f);          
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        gl.glLightfv( GL2.GL_LIGHT0, GL2.GL_POSITION, new float[] {0,0, 0, 0.5f}, 0 );
